...
class TestImportantQuestions:
    ...
    def test_questions_and_answers(self, driver, question_locator, answer_locator, answer_text):

        important_question_page = MainPage(driver)
        ...
        important_question_page.wait_for_clickable_field(question_locator)
